 ...
 */
public class OpenAppendConstruct extends Construct {
    @Override
    ...
    private MetaExpression process(MetaExpression pathVar, ConstructContext context) {
        ...
        if (Files.isDirectory(path)) {
            throw new RobotRuntimeException("Cannot create append target for a directory");
        }
        ...
        IOStream streamBuilder = new PathIOStream(path, StandardOpenOption.WRITE, StandardOpenOption.CREATE, StandardOpenOption.APPEND);
