...
public class Loader implements nl.xillio.contenttools.PluginPackage {
	...
	public static final String[][] HISTORY =
			new String[][] {
					...
					{"2.1.16", "17-04-2014","Hotfix for issues with concatenating strings in general, concatenating strings in lists in specific. Also fixed issue with lists not refreshing in debugger when stepping through code. "}, // Unfortunately																																																																																															// original.
