 ...
 *
 * @param <T>
 *        the input token for this factory
 */
public interface LanguageFactory<T> {
	 ...
	 * @param robotID
	 *        the id that should be set for the robot
	 * @throws XillParsingException
	 *         when the robot cannot be parsed
	 */
	 ...
	 * 
	 * @throws XillParsingException
	 *         when the robot cannot be compiled
	 */
	 ...
	 * 
	 * @param token
	 *        the token used to compile the robot
