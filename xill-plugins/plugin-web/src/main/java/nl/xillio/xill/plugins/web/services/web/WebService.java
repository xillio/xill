...
public interface WebService {
     ...
     * @throws Exception The selenium implementation can throw an exception.
     */
     ...
     * @throws Exception The selinium implementation can throw exceptions.
     */
     ...
     * @param targetFile A file where the downloaded content is to be stored
