 ...
 * This class encapsulates the pooling mechanism for Selenium's PhantomJS processes used in Web.loadpage() Xill function.
 */
public class PhantomJSPool {
	 ...
	 * So the CLI options are like identificators when we are looking in the pool for PJS process with given CLI options.
	 */
	public class Entity implements AutoCloseable {
		...
		/**
		 * @return true if this PJS process is currently in use; otherwise false which means that this PJS process is free to re/use
		 */
	 ...
	 * 
	 * @param driver 
	 * 				WebDriver class representing PhantomJS
