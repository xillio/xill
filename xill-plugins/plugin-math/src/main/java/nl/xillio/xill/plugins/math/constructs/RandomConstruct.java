...
/**
 * <p>The construct of the Random function. </p>
 * <p> The random function receives a {@link LIST} or a {@link ATOMIC} value.</p>
 * <p> In the first case it returns a random value from the {@link LIST}. </p>
 * <p> In the latter it generates a random number </p>
 * @author Ivor
 *
 */
