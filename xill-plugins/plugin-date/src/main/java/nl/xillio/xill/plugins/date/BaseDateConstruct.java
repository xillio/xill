 ...
 */
public abstract class BaseDateConstruct implements Construct {
    /**
     ...
     * @return
     */
    protected static MetaExpression expression(ZonedDateTime date) {
	MetaExpression value = ExpressionBuilder.fromValue(date.toString());
